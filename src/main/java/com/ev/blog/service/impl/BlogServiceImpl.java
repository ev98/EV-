...
import com.ev.blog.dao.BlogDao;
import com.ev.blog.dao.CommentDao;
...
import com.ev.blog.util.MarkdownUtils;
...
public class BlogServiceImpl implements BlogService {
    ...
    public Blog getDetailedBlog(Long id) {
        ...
        if (blog == null) {
            throw new com.blog.exception.NotFoundException("该博客不存在");
        }
    ...
    public Map<String, List<Blog>> archiveBlog() {
        ...
        Map<String, List<Blog>> map = new LinkedHashMap<>(); //按插入顺序读取
        for (String year : set) {
    ...
    public int updateBlog(Blog blog) {
        ...
        BlogAndTag blogAndTag = null;
        //删除
        blogDao.deleteBlogAndTag2(blog.getId());
        for (Tag tag : tags) {
